...
//     // learning rate should not go higher than 0.5 because the higher the value of
//     // the learning
...
//         this.biases = Arrays.copyOf(n.biases, n.biases.length);
...
//             int biasSize = (i == biases.length - 1) ? outputNodes : hiddenNodes;
//             biases[i] = SimpleMatrix.random64(biasSize, 1, -1, 1, rand);
//         }
//     }

//     public void train(double[] inputArray, double[] targetArray) {
//         validateTargetDimensions(targetArray);
//         // modifying the input to only contain the cards we are interested in, not all
//         // possibilities
...
//     private void validateTargetDimensions(double[] targetArray) {
//         if (targetArray.length != outputNodes) {
//             throw new WrongDimensions(targetArray.length, outputNodes, "Output");
//         }
//     }

//     private void printTargetArray(double[] targetArray) {

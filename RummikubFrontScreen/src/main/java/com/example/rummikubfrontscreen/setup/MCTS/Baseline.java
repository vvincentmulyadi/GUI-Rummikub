...
public class Baseline {
    ...
    public ArrayList<Tile> getBestMove(){
        ...
        for (int i = 0; i < moves.size(); i++) {
            ...
            for (Tile tile : currentSet) {
                currentMovePoints += tile.getValue(); // add the value of each tile to the current move points
            }
    ...
    //try and see if the best move is valid in a copy of the board and create a node with uct value

...
public class Board {
    ...
    public static void main(String[] args) {
        ...
        Tile t1 = new Tile(Colour.BLACK, Value.THREE);
        group.add(t1);
        group.add(new Tile(Colour.BLACK, Value.FOUR));
        group.add(new Tile(Colour.BLACK, Value.FIVE));

        ArrayList<Tile> run = new ArrayList<>();
        run.add(new Tile(Colour.RED, Value.EIGHT));
        run.add(new Tile(Colour.BLUE, Value.EIGHT));
        run.add(new Tile(Colour.YELLOW, Value.EIGHT));
        Tile t2 = new Tile(Colour.YELLOW, Value.NINE);
        //run.add(t2);
        ...
        System.out.println(seriesInGame.size());

        System.out.println(boardVerifier(seriesInGame));
